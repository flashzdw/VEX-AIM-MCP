...
2. 克隆仓库到 ~/Projects/VEX-AIM-MCP（Windows 用 %USERPROFILE%\Projects\VEX-AIM-MCP）：
     git clone --recurse-submodules https://github.com/<your-username>/VEX-AIM-MCP.git ~/Projects/VEX-AIM-MCP
     cd ~/Projects/VEX-AIM-MCP
   （`<your-username>` 替换为实际 GitHub 用户名；如果忘了 --recurse-submodules，
...
- 完整 82 工具参数表：aim_mcp_server/README.md
...
完整参数表请见 [aim_mcp_server/README.md](aim_mcp_server/README.md)。

## 文档导航

- [aim_mcp_server/README.md](aim_mcp_server/README.md) — MCP 服务器使用说明 + 全部 82 工具参数表
